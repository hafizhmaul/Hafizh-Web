  ...
  return (
    <Layout id={"home-page"}>
      <div aria-details='container' id="container-landingpage" className='ml-11'>
        <div id="greeting-section" className='text-yellow-origin text-2xl mb-4' aria-details='greeting'>
          <TextLoop mask={true}>
            <span>halo</span>
        ...
        <div id="full-name" aria-details='full-name' className='lowercase font-bold text-7xl mb-7'>Hafizh Maulan<span className='text-yellow-origin blink-text'>a.</span></div>
